...
function fznDatePicker ($log, $document, $filter) {
    ...
    var partials = {
            ...
            headTemplate : '<thead>'+
            '<tr>'+
            '<th class="prev"><i class="material-icons" style="margin-top: -7px;"><</i></th>'+
            '<th colspan="5" class="date-switch"></th>'+
            '<th class="next"><i class="material-icons" style="margin-top: -7px;">></i></th>'+
            '</tr>'+
            '</thead>',
    ...
    function link (scope, element, attrs, model) {
       ...
       scope.closest = function (angelem, selector) {
        ...
        scope.fill= function() {
            ...
            //scope.find(".datepicker-days tbody").prepend('<tr class="days"><td>Sun</td><td>Mon</td><td>Tue</td><td>Wed</td><td>Thu</td><td>Fri</td><td>Sat</td></tr>')
            // 한글 버전 사용 시 윗 줄 주석 처리 후 사용함
            scope.find(".datepicker-days tbody").prepend('<tr class="days"><td>일</td><td>월</td><td>화</td><td>수</td><td>목</td><td>금</td><td>토</td></tr>')
        ...
        scope.init = function () {
            ...
            scope.language          = attrs.language    || scope.locale || "kr";
            scope.autohide          = attrs.autohide    || true;
            scope.weekStart         = attrs.weekstart   || 0;
