app.controller("MemberListCtrl",function($scope, $http, $modal) {
	...
	$scope.memberManage = {
			obj : {
				memberList : "",
				selectAuthor : "",
				selectAuthor : $scope.authorList.code,
				searchName : "",
				searchNumber : "",
				/*selectMajor : ""*/
				selectMajor : $scope.majorList.code
			},
			func : {
				getMemberList : function(){
					
					var param = {
							selectAuthor : $scope.memberManage.obj.selectAuthor,
							searchName : $scope.memberManage.obj.searchName,
							searchNumber : $scope.memberManage.obj.searchNumber,
							selectMajor : $scope.memberManage.obj.selectMajor
