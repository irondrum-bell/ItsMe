				...
				<div class="col-lg-6">
					...
					<div class="input-group">
						<label class="checkbox-inline"><input class='filter'
							type="checkbox" value="정연" checked>정태</label> <label
							class="checkbox-inline"><input class='filter'
							type="checkbox" value="다현" checked>길우</label> <label
							class="checkbox-inline"><input class='filter'
							type="checkbox" value="사나" checked>소연</label> <label
							class="checkbox-inline"><input class='filter'
							type="checkbox" value="나연" checked>용석</label> <label
							class="checkbox-inline"><input class='filter'
							type="checkbox" value="지효" checked>종원</label>
